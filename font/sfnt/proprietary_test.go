...
go test github.com/hmmftg/image/font/sfnt -args -proprietary
...
go test github.com/hmmftg/image/font/sfnt -test.run=ProprietaryMicrosoft -args -proprietary etc
*/
